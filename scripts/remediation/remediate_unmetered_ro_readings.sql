-- scripts/remediation/remediate_unmetered_ro_readings.sql
--
-- Remediation script for historical ro_train_readings where operators saved readings
...
--
-- IMPORTANT:
-- Run and verify on STAGING database first before applying to production.
--
-- Actions performed:
