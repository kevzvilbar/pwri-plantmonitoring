...
// the two files actually has what you need; TrendChart.tsx currently wires
// these into Production/NRW, Raw Water's By-well breakdown, and Plant
// Health's daily→hourly drill — TDS/Recovery's by-train view is the one
// remaining chart still on daily-only lines (see TrendChart.tsx's roDrillMode
// comment) and is a good next candidate for the same treatment.
