...
export default function Dashboard() {
  ...
  useEffect(() => {
    ...
    // RO quality threshold alerts — plant_id reattached by latestRO query
    ...
    if (storeAlerts.length > 0) addAlerts(storeAlerts);
  // eslint-disable-next-line react-hooks/exhaustive-deps
  }, [trainGaps, latestRO, chemInv, feedAlerts, selectedPlantId]);
