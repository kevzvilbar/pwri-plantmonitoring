...
type Tone = 'default' | 'accent' | 'warn' | 'danger' | 'info' | 'muted' | 'highlight';

const tones: Record<Tone, string> = {
  default:   'bg-secondary text-secondary-foreground',
  accent:    'bg-accent-soft text-accent dark:text-emerald-300',
  warn:      'bg-warn-soft text-warn-foreground',
  danger:    'bg-danger-soft text-danger',
  info:      'bg-info-soft text-info',
  muted:     'bg-muted text-muted-foreground',
  highlight: 'bg-highlight-soft text-highlight dark:text-cyan-300',
};
