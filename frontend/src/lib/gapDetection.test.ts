...
describe('gapDetection', () => {
  ...
  describe('detectGaps', () => {
    ...
    it('detects and backfills a 2-day gap with even split', () => {
    ...
    it('skips interpolation across meter replacement / rollover resets', () => {
      const readings: RawReading[] = [
        {
          id: '1',
          well_id: 'well-1',
      ...
      const fills = detectGaps(readings, 'current_reading', 'well_readings', mockFkLookup);
      expect(fills).toHaveLength(0);
    });
  });
});
