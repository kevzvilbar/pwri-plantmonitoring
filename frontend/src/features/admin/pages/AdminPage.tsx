...
// ─────────────────────────────────────────────────────────────────────────────
const UsersPanel = lazy(() => import('../components/panels/UsersPanel').then(m => ({ default: m.UsersPanel })));
const PlantsPanel = lazy(() => import('../components/panels/PlantsPanel').then(m => ({ default: m.PlantsPanel })));
const AuditLogPanel = lazy(() => import('../components/panels/AuditLogPanel').then(m => ({ default: m.AuditLogPanel })));
const MigrationsPanel = lazy(() => import('../components/panels/MigrationsPanel').then(m => ({ default: m.MigrationsPanel })));
const RolesPanel = lazy(() => import('../components/panels/RolesPanel').then(m => ({ default: m.RolesPanel })));
