...
vi.mock('../components/locators/LocatorSection', () => ({ LocatorReadingForm: () => <div data-testid="locator-form" /> }));
vi.mock('../components/blending/BlendingSection', () => ({ BlendingForm: () => <div data-testid="blending-form" /> }));
vi.mock('../components/product/ProductSection', () => ({ ProductForm: () => <div data-testid="product-form" /> }));
