  ...
  return (
    <div className="grid grid-cols-2 sm:grid-cols-4 gap-2.5 sm:gap-3">
      <Card
        ...
        className={cn(
          'p-3 sm:p-3.5 rounded-xl border transition-all cursor-pointer hover:shadow-xs',
      ...
      >
        ...
        <div className="text-xl sm:text-2xl font-bold font-mono-num text-foreground tracking-tight">
          {plantAlertsLength}
        </div>
      ...
      >
        ...
        <div className="text-xl sm:text-2xl font-bold font-mono-num text-danger tracking-tight">
          {criticalCount}
        </div>
      ...
      >
        ...
        <div className="text-xl sm:text-2xl font-bold font-mono-num text-amber-500 tracking-tight">
          {warningCount}
        </div>
