/**
 * data/queries/compliance.ts — Compliance query functions.
 *
 * Roadmap Phase 3: the data-access layer. Pure query functions for
 * compliance metrics, thresholds, fleet summaries, and chemical supply.
...
export async function fetchFleetCompliance(
  plants: Array<{ id: string; name: string }>,
  days: number,
): Promise<PlantComplianceSummary[]> {
...
export { DEFAULT_THRESHOLDS, computeComplianceScore };