...
export async function fetchPlantMetrics(
  ...
  // NOTE: neither 'nrw_pct' nor 'nrw_percentage' exist as columns on
  // daily_plant_summary — this always resolves to undefined until NRW% is
  // actually computed from production_m3 / locator_consumption_m3 /
  // raw_water_consumption_m3 / blending_m3. Flagging rather than guessing
  // at the formula here (same gap noted in backend/cron_service.py).
  return {
    rows,
    metrics: {
      ...
      raw_turbidity: avg('raw_turbidity_ntu'),
      dp_psi:        avg('dp_psi'),
