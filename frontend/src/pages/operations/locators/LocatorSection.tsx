...
function LocatorRow({
  ...
  const recalcNow = async () => {
    ...
    try {
      ...
      // Partial match: ReadingHistoryDialog's key is
      // ['reading-history', 'locator', locator.id, days, from, to] — this
      // invalidates every window/date-range variant for this locator, not
      // just whichever one happens to be open.
