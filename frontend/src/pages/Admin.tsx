      ...
      <div className="space-y-4 animate-fade-in" data-testid="admin-page-analyst">
        <div>
          ...
          <p className="text-xs text-muted-foreground">
            Reading corrections and pending reviews have moved to Data Corrections.
          </p>
        </div>

        <Card className="p-5 flex flex-col sm:flex-row items-start sm:items-center gap-4">
          <ClipboardCheck className="h-8 w-8 text-teal-600 shrink-0" aria-hidden />
          ...
          <button
            ...
            className="inline-flex items-center gap-2 rounded-md bg-teal-700 px-4 py-2 text-sm font-medium text-white hover:bg-teal-800 transition-colors shrink-0"
          >
