      ...
      <div className="space-y-4 animate-fade-in" data-testid="admin-page-analyst">
        ...
        <Card className="p-5 flex flex-col sm:flex-row items-start sm:items-center gap-4">
          ...
          <button
            ...
            className="inline-flex items-center gap-2 rounded-md bg-primary px-4 py-2 text-sm font-medium text-white hover:bg-primary/90 transition-colors shrink-0"
          >
