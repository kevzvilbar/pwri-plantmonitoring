        ...
        <ResponsiveContainer width="100%" height="100%">
          {(hasRoDrill && roDrillMode === 'by-train') ? (
            ...
            <ComposedChart data={chartData} margin={{ top: 4, right: 8, left: 0, bottom: 0 }}>
              ...
              <YAxis yAxisId="pct" orientation="right" tick={{ fontSize: 10 }} stroke="hsl(var(--chart-4))" width={28} tickFormatter={(v) => `${v}%`} />
              ...
              <Line yAxisId="pct" type="monotone" dataKey="nrw" stroke="hsl(var(--chart-4))" strokeWidth={2.5} dot={{ r: 3, fill: "hsl(var(--chart-4))" }} name="NRW %" />
            </ComposedChart>
