...
const ALL_ROLES = ['Operator', 'Technician', 'Supervisor', 'Manager', 'Data Analyst', 'Admin'] as const;
type AppRole = typeof ALL_ROLES[number];

const ROLE_ORDER: AppRole[] = ['Admin', 'Data Analyst', 'Manager', 'Supervisor', 'Technician', 'Operator'];
...
const CARD_ROLES: AppRole[] = ['Admin', 'Data Analyst', 'Manager', 'Supervisor'];
