...
READ_WHITELIST: dict[str, set[str]] = {
    "plants": {"id", "name", "address", "status", "design_capacity_m3",
               "num_ro_trains"},
    ...
    "ro_train_readings": {
        "id", "plant_id", "train_id", "reading_datetime",
        "permeate_tds", "permeate_ph", "turbidity_ntu",
        "dp_psi", "recovery_pct",
    },
    "chemical_inventory": {"id", "plant_id", "chemical_name",
                            "current_stock", "unit", "updated_at"},
    "daily_plant_summary": {
        "id", "plant_id", "summary_date",
        "production_m3", "locator_consumption_m3", "raw_water_consumption_m3",
        "downtime_hrs", "permeate_tds", "permeate_ph",
        "raw_turbidity_ntu", "dp_psi", "recovery_pct", "pv_ratio",
    },
    "incidents": {"id", "plant_id", "when_datetime", "severity",
                   "incident_type", "what_description", "status"},
